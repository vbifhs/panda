...
from panda.tests.hitl.helpers import get_random_can_messages, time_many_sends, clear_can_buffers
...
def test_latency(p, panda_jungle):
  ...
  p.set_safety_mode(Panda.SAFETY_ALLOUTPUT)
  print()
  print("="*15, "panda -> jungle", "="*15)
  test(p, panda_jungle)
  print()
  print()
  print("="*15, "jungle -> panda", "="*15)
  test(panda_jungle, p)
...
def test_message_integrity(p):
  ...
  for i in range(n):
    ...
    for _ in range(random.randrange(10)):
      to_send = get_random_can_messages(100)
